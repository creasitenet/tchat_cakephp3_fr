...
var tchat_timer = setInterval(function(){ajax_refresh("tchats/getAjaxRefresh", "", "#tchat_messages")},5000);
var user_timer = setInterval(function(){ajax_refresh("users/getAjaxRefresh", "", "#tchat_users")},10000);
...
$(document).ready(function(){
  ...
  $('#tchat_messages').scrollTop($('#tchat_messages')[0].scrollHeight);
	...
	function ajax_refresh_one(url, data, div) {
    	$.get(url,function(response){ 
	        //console.log(response);
        	$(div).append(response)
